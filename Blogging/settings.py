...
SECRET_KEY = 'django-insecure-df!&2sod^%%y613s#fe#w8-y8b9$w7(r09qvhofm-z(la1xy-)'
...
DATABASES = {
    'default': {
        ...
        'NAME': str(BASE_DIR.parent / 'tamilLyrical.sqlite3'),
    }
}
...
ROBOTS_SITEMAP_URLS = [
    'https://tamillyrical.telekit.link/lyrics-sitemap.xml',
    'https://tamillyrical.telekit.link/movie-sitemap.xml',
    'https://tamillyrical.telekit.link/singer-sitemap.xml',
